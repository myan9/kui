...
localDescribe('Click on action part of activation sidecar', function (this: common.ISuite) {
  ...
  it('should create a package', () => cli.do(`wsk package create ppp`, this.app)
    ...
    .catch(common.oops(this)))
  it('should create a package action', () => cli.do(`wsk action create ppp/foo ${ROOT}/data/openwhisk/foo.js`, this.app)
    .then(cli.expectJustOK)
    .then(sidecar.expectOpen)
