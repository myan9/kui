...
Common.localDescribe('kubectl context switching', function(this: Common.ISuite) {
  ...
  synonyms.forEach(kubectl => {
    ...
    // const widget = await this.app.client.$('#kui--plugin-kubeui--current-context button')
    // await widget.click()

    // const menuItem = await this.app.client.$(`.bx--list-box__menu-item[title="${contextName}"]`)
