...
import { Arguments, ModificationState, i18n, TreeItem, TreeResponse, Table } from '@kui-shell/core'
...
interface BucketValue {
  ...
  modifiedRaw?: string
  modification: TreeItem['modification']
  id: string
  name: string
    ...
    const data = [
      {
        ...
        modification: buckets.all.all.modification,
