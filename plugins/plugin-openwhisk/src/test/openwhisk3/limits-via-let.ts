...
localDescribe('Create an action with limits, using let', function (this: common.ISuite) {
  ...
  it('should create an action with -m 129', () => cli.do(`let ${actionName1} = ${ROOT}/data/openwhisk/foo.js -m 129`, this.app)
    .then(cli.expectOK)
  ...
  it('should create an action with --memory 131', () => cli.do(`let ${actionName2} = ${ROOT}/data/openwhisk/foo.js --memory 131`, this.app)
    .then(cli.expectOK)
    .then(sidecar.expectOpen)
  ...
  it('should create an action with -t 1000', () => cli.do(`let ${actionName3} = ${ROOT}/data/openwhisk/foo.js -t 1000`, this.app)
    .then(cli.expectOK)
    .then(sidecar.expectOpen)
  ...
  it('should create an action with --timeout 2000', () => cli.do(`let ${actionName4} = ${ROOT}/data/openwhisk/foo.js --timeout 2000`, this.app)
    .then(cli.expectOK)
    .then(sidecar.expectOpen)
  ...
  it('should create an action with --timeout 3s', () => cli.do(`let ${actionName5} = ${ROOT}/data/openwhisk/foo.js --timeout 3s`, this.app)
    .then(cli.expectOK)
    .then(sidecar.expectOpen)
  ...
  it('should create an action with --timeout 5m', () => cli.do(`let ${actionName6} = ${ROOT}/data/openwhisk/foo.js --timeout 5m`, this.app)
    .then(cli.expectOK)
    .then(sidecar.expectOpen)
  ...
  it('should create an action with -l 1', () => cli.do(`let ${actionName7} = ${ROOT}/data/openwhisk/foo.js -l 1`, this.app)
    .then(cli.expectOK)
    .then(sidecar.expectOpen)
  ...
  it('should create an action with --logsize 2', () => cli.do(`let ${actionName8} = ${ROOT}/data/openwhisk/foo.js --logsize 2`, this.app)
    .then(cli.expectOK)
    .then(sidecar.expectOpen)
  ...
  it('should create an action with --logsize 3', () => cli.do(`let ${actionName8} = ${ROOT}/data/openwhisk/foo.js --logsize 3`, this.app)
    .then(cli.expectOK)
    .then(sidecar.expectOpen)
    .then(sidecar.expectShowing(actionName8))
  ...
  it('should create an action with --logsize 3', () => cli.do(`let ${actionName9} = ${ROOT}/data/openwhisk/foo.js --logsize 3`, this.app)
    .then(cli.expectOK)
    .then(sidecar.expectOpen)
