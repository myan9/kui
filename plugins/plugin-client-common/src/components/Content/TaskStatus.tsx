...
export default class TaskStatus extends React.PureComponent<Props, State> {
  ...
  public componentDidMount() {
    eventChannelUnsafe.on(`/block/update/${this.props.link}`, this.reportStatus.bind(this))
    eventChannelUnsafe.emit(`block/status/get`, this.props.link)
  }

  /** Bye! */
  public componentWillUnmount() {
    eventBus.off(`/block/update/${this.props.link}`, this.reportStatus.bind(this))
  }
